...
const settingsSchema = new mongoose.Schema({
  ...
  companyName: {
    type: String,
    default: 'ألوان السفر للسفر والسياحة'
  },
  companyNameEn: {
    type: String,
  ...
  // بيانات التسجيل الرسمية — تظهر في تذييل الموقع العام
  tourismLicense: {
    type: String,
    default: '73104877'
  },
...
ملاحظة: في حالة الإلغاء، قد تستغرق عملية استرداد المبلغ ما يصل إلى 30 يوم عمل.`
  ...
  receiptTerms: {
    type: String,
    default: `شكراً لاختياركم ألوان السفر
...
settingsSchema.statics.getSettings = async function() {
  ...
  if (!settings) {
    settings = await this.create({
      key: 'main',
      companyName: 'الوان السفر للسفر والسياحة',
