...
// ============================================================
//  النسبة الصحيحة لأسماء الدول بالعربية
// ============================================================
const COUNTRY_ADJECTIVES = {
  ...
  'الصين': 'الصينية',
  'اليابان': 'اليابانية',
  'كوريا الجنوبية': 'الكورية الجنوبية',
  'تايلاند': 'التايلاندية',
  'ماليزيا': 'الماليزية',
  'إندونيسيا': 'الإندونيسية',
  'سنغافورة': 'السنغافورية',
  'فيتنام': 'الفيتنامية',
  'سريلانكا': 'السريلانكية',
  'جورجيا': 'الجورجية',
  'أذربيجان': 'الأذربيجانية',
  'أرمينيا': 'الأرمينية',
  'أوزبكستان': 'الأوزبكستانية',
  'كازاخستان': 'الكازاخستانية',
  'روسيا': 'الروسية',
  'أوكرانيا': 'الأوكرانية',
  'كندا': 'الكندية',
  'المكسيك': 'المكسيكية',
  'البرازيل': 'البرازيلية',
  'الأرجنتين': 'الأرجنتينية',
  'كولومبيا': 'الكولومبية',
  'أستراليا': 'الأسترالية',
  'نيوزيلندا': 'النيوزيلندية',
  'جنوب أفريقيا': 'جنوب الأفريقية',
  'كينيا': 'الكينية',
  'تنزانيا': 'التنزانية',
  'إثيوبيا': 'الإثيوبية',
  'نيجيريا': 'النيجيرية',
  'المالديف': 'المالديفية',
  'موريشيوس': 'الموريشيوسية',
  'سيشل': 'السيشلية',
  'قبرص': 'القبرصية',
  'مالطا': 'المالطية',
  'أيسلندا': 'الأيسلندية',
  ...
  'البوسنة والهرسك': 'البوسنية',
  'مقدونيا الشمالية': 'المقدونية',
};
...
const VisaCatalogTab = () => {
  ...
  const selectCountry = (country) => {
    const adj = COUNTRY_ADJECTIVES[country.ar] || country.ar;
    setForm(prev => ({
      ...prev,
      countryName: `التأشيرة ${adj}`,
