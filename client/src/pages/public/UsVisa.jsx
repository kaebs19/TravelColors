  ...
  return (
    <div className="usvisa-page" dir="rtl">
      ...
      <div className="usvisa-banner">
        ...
        <h1>التأشيرة الأمريكية</h1>
        <p>جميع المتطلبات والمستندات المطلوبة للحصول على تأشيرتك</p>
      </div>
      ...
      <div className="usvisa-content">
        <div className="usvisa-types-section animate-on-scroll">
          ...
          <div className="usvisa-types-grid">
            <div className="usvisa-type-card animate-on-scroll delay-1">
              <div className="usvisa-type-icon">
              ...
              <h4>تأشيرة سياحية</h4>
              <p>للسياحة والزيارات العائلية</p>
              <div className="usvisa-type-price">
                <span className="usvisa-price-amount">950</span>
                <span className="usvisa-price-currency">ريال</span>
              </div>
            </div>
            <div className="usvisa-type-card animate-on-scroll delay-2">
              <div className="usvisa-type-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="32" height="32"><path d="M22 12h-4l-3 9L9 3l-3 9H2" strokeLinecap="round" strokeLinejoin="round"/></svg>
              </div>
              <h4>تأشيرة علاج</h4>
              <p>للعلاج والاستشفاء في أمريكا</p>
              <div className="usvisa-type-price">
                <span className="usvisa-price-amount">950</span>
                <span className="usvisa-price-currency">ريال</span>
              </div>
            </div>
            <div className="usvisa-type-card animate-on-scroll delay-3">
              <div className="usvisa-type-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="32" height="32"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c0 1.657 2.686 3 6 3s6-1.343 6-3v-5" strokeLinecap="round" strokeLinejoin="round"/></svg>
              </div>
              <h4>تأشيرة دراسة</h4>
              <p>للدراسة في الجامعات الأمريكية</p>
              <div className="usvisa-type-price">
                <span className="usvisa-price-amount">1200</span>
                <span className="usvisa-price-currency">ريال</span>
              </div>
            </div>
          </div>
        ...
        <div className="usvisa-block animate-on-scroll">
          ...
          <div className="usvisa-info-card">
            <p>المدة المعتادة: من 2 إلى 5 أيام عمل بعد إجراء المقابلة الشخصية</p>
          </div>
        ...
        <div className="usvisa-cta-wrapper animate-on-scroll">
          ...
          <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="pbtn pbtn-lg pbtn-whatsapp usvisa-consult-btn">
